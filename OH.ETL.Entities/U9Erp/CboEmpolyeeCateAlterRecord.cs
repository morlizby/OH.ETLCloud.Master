...
public partial class CboEmpolyeeCateAlterRecord
{
    ...
    public long PersonCate { get; set; }
    ...
    public int? CreateActive { get; set; }

    public long? CreateDoc { get; set; }

    public int? ActiveEnd { get; set; }

    public long? EndDoc { get; set; }

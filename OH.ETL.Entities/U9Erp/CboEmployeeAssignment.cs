...
public partial class CboEmployeeAssignment
{
    ...
    public long BusinessOrg { get; set; }
    ...
    public long? WorkAddress { get; set; }

    public long? JobTitleLevel { get; set; }

    public bool? IsTakeUp { get; set; }

    public bool? IsMain { get; set; }

    public bool? IsProbation { get; set; }

    public int? AssignActive { get; set; }

    public DateTime AssgnBeginDate { get; set; }

    public DateTime? AssgnEndDate { get; set; }

    public long? AssignDoc { get; set; }

    public DateTime? PlanChangeDate { get; set; }

    public DateTime? PlanEndDate { get; set; }

    public int? EndAssignActive { get; set; }

    public long? PlanEndDoc { get; set; }

    public DateTime? ProBeginDate { get; set; }

    public decimal? ProMonth { get; set; }

    public DateTime? ProOverDate { get; set; }

    public long? GuideMan { get; set; }

    public int? ProbationStatus { get; set; }

    public DateTime? ProbationDelayDate { get; set; }

    public long? ProDoc { get; set; }

    public long? AssignBeforeAlter { get; set; }
    ...
    public long OwnerOrg { get; set; }

    public long WorkOrg { get; set; }
